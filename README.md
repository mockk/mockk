...
<td>
    <pre>testCompile "io.mockk:mockk:1.5.2"</pre>
    </td>
</tr>
<tr>
...
<code>agent "io.mockk:mockk-agent:1.5.2"</code>
...
<code>-javaagent: ${HOME}/.m2/repository/ io/mockk/mockk-agent/1.5.2/ mockk-agent-1.5.2.jar</code>
