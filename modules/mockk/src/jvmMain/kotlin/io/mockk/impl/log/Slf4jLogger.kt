...
class Slf4jLogger(
    ...
    override fun error(
        ex: Throwable,
        msg: () -> String,
    ) = if (log.isErrorEnabled) log.error(msg(), ex) else Unit
    ...
    override fun warn(
        ex: Throwable,
        msg: () -> String,
    ) = if (log.isWarnEnabled) log.warn(msg(), ex) else Unit
    ...
    override fun info(
        ex: Throwable,
        msg: () -> String,
    ) = if (log.isInfoEnabled) log.info(msg(), ex) else Unit
    ...
    override fun debug(
        ex: Throwable,
        msg: () -> String,
    ) = if (log.isDebugEnabled) log.debug(msg(), ex) else Unit
    ...
    override fun trace(
        ex: Throwable,
        msg: () -> String,
    ) = if (log.isTraceEnabled) log.trace(msg(), ex) else Unit
}
