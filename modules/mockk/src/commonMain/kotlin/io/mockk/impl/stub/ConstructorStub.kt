...
class ConstructorStub(
    ...
    override fun answer(invocation: Invocation) =
        stub
            .answer(
    ...
    override fun allRecordedCalls(method: MethodDescription) =
        stub
            .allRecordedCalls(method)
            .map {
                it.substitute(revertRepresentation)
            }

    override fun verifiedCalls() =
        stub
            .verifiedCalls()
            .map {
                it.substitute(revertRepresentation)
    ...
    override fun clear(options: MockKGateway.ClearOptions) = stub.clear(options)
