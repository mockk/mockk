...
import com.ninjasquad.springmockk.hierarchies.MockkBeanByTypeInParentContextHierarchyTests.Config1
import com.ninjasquad.springmockk.hierarchies.MockkBeanByTypeInParentContextHierarchyTests.Config2
...
class MockkBeanByTypeInParentContextHierarchyTests {
    @MockkBean(contextName = "parent")
    ...
    @Test
    fun test() {
        every { service.greeting() } returns "Mock 1"
