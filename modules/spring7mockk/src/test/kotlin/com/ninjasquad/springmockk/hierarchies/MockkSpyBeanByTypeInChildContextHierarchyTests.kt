...
import com.ninjasquad.springmockk.hierarchies.MockkSpyBeanByTypeInChildContextHierarchyTests.Config1
import com.ninjasquad.springmockk.hierarchies.MockkSpyBeanByTypeInChildContextHierarchyTests.Config2
...
class MockkSpyBeanByTypeInChildContextHierarchyTests {
    @MockkSpyBean(contextName = "child")
    ...
    fun test(context: ApplicationContext) {
        val serviceInParent = context.parent!!.getBean(ExampleService::class.java)
