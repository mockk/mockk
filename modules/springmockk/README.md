# SpringMockK - Spring Framework 7 Support
...
This module supports **Spring Framework 7** and **Spring Boot 4**:
...
This is the main SpringMockK module that supports the latest Spring Framework versions. For older Spring Boot versions, see:
...
```bash
./gradlew :modules:springmockk:build
```
