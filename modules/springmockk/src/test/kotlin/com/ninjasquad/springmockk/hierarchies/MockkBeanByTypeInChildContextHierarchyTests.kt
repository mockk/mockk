...
import com.ninjasquad.springmockk.hierarchies.MockkBeanByTypeInChildContextHierarchyTests.Config1
import com.ninjasquad.springmockk.hierarchies.MockkBeanByTypeInChildContextHierarchyTests.Config2
...
class MockkBeanByTypeInChildContextHierarchyTests {
    ...
    fun test(context: ApplicationContext) {
        ...
        every { service.greeting() } returns "Mock 2"
