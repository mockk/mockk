...
import com.ninjasquad.springmockk.hierarchies.MockkSpyBeanByNameInChildContextHierarchyTests.Config1
import com.ninjasquad.springmockk.hierarchies.MockkSpyBeanByNameInChildContextHierarchyTests.Config2
...
class MockkSpyBeanByNameInChildContextHierarchyTests {
    @MockkSpyBean(name = "service", contextName = "child")
    ...
    fun test(context: ApplicationContext) {
        val serviceInParent: ExampleService = context.parent!!.getBean(ExampleService::class.java)
        ...
        assertThat(serviceCaller2.service).isSameAs(service)
