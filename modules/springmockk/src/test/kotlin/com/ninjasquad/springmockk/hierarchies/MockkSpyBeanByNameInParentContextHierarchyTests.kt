...
import com.ninjasquad.springmockk.hierarchies.MockkSpyBeanByNameInParentContextHierarchyTests.Config1
import com.ninjasquad.springmockk.hierarchies.MockkSpyBeanByNameInParentContextHierarchyTests.Config2
...
class MockkSpyBeanByNameInParentContextHierarchyTests {
    @MockkSpyBean(name = "service", contextName = "parent")
    ...
    fun test() {
        ...
        assertThat(serviceCaller1.service).isSameAs(service)
