 ...
 * @author Phillip Webb
 * @since 6.2
 * @see MockkBeanWithMultipleExistingBeansAndOnePrimaryAndOneConflictingQualifierIntegrationTests
 *
 * @see MockkBeanWithMultipleExistingBeansAndExplicitBeanNameIntegrationTests
 *
 * @see MockkBeanWithMultipleExistingBeansAndExplicitQualifierIntegrationTests
 */
@ExtendWith(SpringExtension::class)
class MockkBeanWithMultipleExistingBeansAndOnePrimaryIntegrationTests {
    @MockkBean
