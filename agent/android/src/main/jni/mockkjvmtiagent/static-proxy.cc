...
namespace io_mockk_proxy_android {
    ...
    Java_io_mockk_proxy_android_StaticClassTransformer_nativeRedefine(JNIEnv* env,
                                                                           jobject generator,
                                                                           jstring idStr,
    ...
    Java_io_mockk_proxy_android_StaticJvmtiAgent_nativeRegisterTransformerHook(JNIEnv* env,
                                                                                     jobject thiz) {
    ...
    extern "C" JNIEXPORT void JNICALL
    Java_io_mockk_proxy_android_StaticJvmtiAgent_nativeUnregisterTransformerHook(JNIEnv* env,
                                                                                     jobject thiz) {
    ...
    extern "C" JNIEXPORT void JNICALL
    Java_io_mockk_proxy_android_StaticJvmtiAgent_nativeRetransformClasses(JNIEnv* env,
                                                                             jobject thiz,
...
#define REALMETHOD_CALL_STACK_FRAME (23)
    ...
    Java_io_mockk_proxy_android_StaticMockMethodAdvice_nativeGetCalledClassName(JNIEnv* env,
                                                                                     jclass klass) {
        JavaVM *vm;
